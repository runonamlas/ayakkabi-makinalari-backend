...
func (db *productConnection) FindProductByID(productID uint64) entity.Product {
	...
	db.connection.Preload("Routes").Preload("City.Country").Preload("Category").Find(&product, productID)
	return product
}
...
func (db *productConnection) AllProducts() []entity.Product {
	var products []entity.Product
	db.connection.Preload("Routes").Preload("City.Country").Preload("Category").Find(&products)
	return products
}
